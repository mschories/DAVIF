...
Die folgenden Zeilen können auf der Website [zur Abfrag von Wikidata](https://query.wikidata.org) reinkopiert werden. Als Antwort bekommt man eine Liste von Frauen, mit Namen, Links auf die Wikidataseite (enthält die ID auf Wikidata) und den Wert, den die WFPP-ID auf Wikidata hat. Dadurch, dass diese Anfrage so offen gestellt ist, unabhängig von den lokalen Daten, kommen hier auch solche Frauen zurück, die in den lokalen Daten aus dem Juli 22 noch nicht enthalten sind. 
...
Der zweite Ansatz setze nicht die Tätigkeit in der Abfrage voraus, sondern kehrte das um, fragte nach der Tätigkeit. Die Wikidata-Abfrage lautete: Gib mir alle Einträge, die eine Subkategorie von Film sind und in denen diese Frau genannt wird. 
...
Die Filmografien, eingesammelt von Wikidata kommen momentan noch nicht zum Einsatz. 
...
Und ebenso die der DFF-Frauen [Link zur Tabelle]()
...
Für diejenigen Frauen, für die auch schon WFPP-Filmografien vorliegen und Übereinstimmungen zum DFF haben, gibt es für fast alle auch Wikidata-Informationen. Lediglich für Stella F. Simon sind keine Filminformationen auf Wikidata dokumentiert. 

Aus dem gemeinsamen Datensatz von WFPP- und DFF-Daten mit 54 Frauen, sind von 51 Frauen auch Tätigkeiten dokumentiert. Welche fehlen?
