...
id_cols <- c("filename", "Title", "Archives", "archives", "unfinished", "uncertainty", "Release_years", "Release_Years", "production_company", "Production_Company", "Production_Country")

df_wfpp_filmography_long <- df_wfpp_filmography_wide %>% 
  select(!!!id_cols, everything()) %>% #View()
...
write_csv(df_wfpp_filmography_ids, "data/doc/wfpp-filmography-pauline-ids.csv") 
