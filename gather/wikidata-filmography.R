...
## die hier genutzte Funktion aus dem wikidata-package hat ein issue mit curl: wenn ich versuche den ganzen df aufeinmal abzufragen, wird intern versucht eine Variable zu überschreiben, was aber nicht funktioniert.
...
## unter allen subclass = film nach den frauennamen suchen:
...
save(filmography_unique_films, file = "data/wikidata/filmography_unique_films.RData")
write_csv(filmography_unique_films, file = "data/wikidata/filmography_unique_films.csv")
